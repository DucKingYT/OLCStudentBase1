...
#------------------------------------------------------------
# must check whether its a number and also between the range

# while True:
#     score = input("Enter your score: ")
#     if score.isdigit():
#         score = int(score) # convert here
        
#     if not(score.isdigit()) < 0 or score > 100:
...
while True:
    ...
    password = input("Enter a password: ") #password123 < 8
    if password == "":
        print("Error: Password is empty")
    
    if len(password) >= 8 and password <= 16:
        print("Error: Password must be between 8 and 16 characters")
        haslength = True
    
    if " " not in password:
        print("Error: Password has a space")
        gotspace = True
